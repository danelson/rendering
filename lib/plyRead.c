...
//			p[i].zBufferFlag = 1;
			...
			if(estNormals) {
				...
				tx.v[0] = p[i].vertex[0].val[0] - p[i].vertex[1].val[0];
				tx.v[1] = p[i].vertex[0].val[1] - p[i].vertex[1].val[1];
				tx.v[2] = p[i].vertex[0].val[2] - p[i].vertex[1].val[2];

				ty.v[0] = p[i].vertex[2].val[0] - p[i].vertex[1].val[0];
				ty.v[1] = p[i].vertex[2].val[1] - p[i].vertex[1].val[1];
				ty.v[2] = p[i].vertex[2].val[2] - p[i].vertex[1].val[2];
